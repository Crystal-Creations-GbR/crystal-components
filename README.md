...
[![GitHub release (latest SemVer)](https://img.shields.io/github/v/release/servely/crystal-components?sort=semver)](https://github.com/servely/crystal-components/releases) [![GitHub](https://img.shields.io/github/license/servely/crystal-components)](LICENSE) [![Build and publish npm package](https://github.com/servely/crystal-components/actions/workflows/publish.yml/badge.svg)](https://github.com/servely/crystal-components/actions/workflows/publish.yml) [![npm](https://img.shields.io/npm/v/@crystal-creations/crystal-components)](https://www.npmjs.com/package/@crystal-creations/crystal-components) [![npm](https://img.shields.io/npm/dw/@crystal-creations/crystal-components)](https://www.npmjs.com/package/@crystal-creations/crystal-components)

A vuetify based component library from Servely.
    ...
    <template>
       <CLicenseCard
         :software-info="{
           ...
           version: 'v1.0.0',
           repositoryLink:
             'https://github.com/servely/crystal-components',
           notice: 'MIT',
         }"
       ></CLicenseCard>
    </template>
